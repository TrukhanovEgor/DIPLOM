...
def Back1(e, page):
    ...
    app_bar = ft.AppBar(
        leading=back_button,
        title=ft.Text("Подтягивания", size=15, color=ft.colors.WHITE),
        bgcolor=ft.colors.DEEP_ORANGE_300,
        center_title=True,
    )

    video_path = ft.VideoMedia("video/video_Back//06521001.mp4")
    ...
    muscles = ft.Container(
        content=ft.Text("Мышцы : широчайшие мышцы ", size=17, weight=ft.FontWeight.BOLD, color=ft.colors.WHITE),
        padding=ft.padding.all(10),
        border_radius=15,
    )
