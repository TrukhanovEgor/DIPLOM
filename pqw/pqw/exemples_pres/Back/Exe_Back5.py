...
def Back5(e, page):
    ...
    app_bar = ft.AppBar(
        leading=back_button,
        title=ft.Text("Тяга гантели одной рукой в \n наклоне ", size=17, color=ft.colors.WHITE),
        bgcolor=ft.colors.DEEP_ORANGE_300,
        center_title=True,
    )

    video_path = ft.VideoMedia("video/video_Back//0292005.mp4")
    ...
    muscles = ft.Container(
        content=ft.Text("Мышцы : широчайшие мышцы спины", size=17, weight=ft.FontWeight.BOLD, color=ft.colors.WHITE),
        padding=ft.padding.all(10),
        border_radius=15,
    )
